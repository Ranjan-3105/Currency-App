...
const VoiceInteraction: React.FC = () => {
  ...
  {type: 'bot',
  message: "Didn,t get what you said !",
  timestamp: new Date}
]);
...
const {
  ...
  // recordingStatus,
  // recordingTime
} = useAudioRecorder() as ReturnType<typeof useAudioRecorder>;
...
// ## message : voice to text <code here>

// ## api post and get req to getch the api response . and display it in the chat box
